<?php
		...
		$query = "SELECT part_name, part_number, option_code, qty, serial_number, remarks FROM jd_4039_df008";
		$result = mysqli_query($mysqli, $query);
	    
    	$engine = array("Oil"=>12, "Coolant"=>16.5, "Model"=>"4039DF008");
		$consumption = array("25%"=>2.2, "50%"=>3.7, "75%"=>5.2,"100%"=>6.9);
